...
public class BubbleView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //背景颜色
        int backGroundColor = ta.getColor(R.styleable.BubbleView_background_color, Color.WHITE);
        //阴影颜色
        int shadowColor = ta.getColor(R.styleable.BubbleView_shadow_color,
                Color.parseColor("#999999"));
        int defShadowSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_PX,
                4, getResources().getDisplayMetrics());
        //阴影尺寸
        int shadowSize = ta.getDimensionPixelSize(R.styleable.BubbleView_shadow_size, defShadowSize);
        mRadius = ta.getDimensionPixelSize(R.styleable.BubbleView_radius, 0);
        //三角形方向
        mDirection = ta.getInt(R.styleable.BubbleView_direction, TOP);
        mOffset = ta.getDimensionPixelOffset(R.styleable.BubbleView_offset, 0);
        ta.recycle();
